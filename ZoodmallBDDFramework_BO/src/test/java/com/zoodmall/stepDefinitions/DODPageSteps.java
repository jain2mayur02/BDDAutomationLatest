...
public class DODPageSteps {
	...
	public void create_the_deal_of_the_dod() throws InterruptedException, IOException {
		dealofdaypage.createdod();

	}

	@Then("^verify deal should be create successfully$")
	public void verify_deal_should_be_create_successfully() throws InterruptedException, IOException {
		dealofdaypage.verifycreate();

	}

	@And("^sync deal created$")
	public void sync_deal_created() throws InterruptedException, IOException {
	...
	@And("^delete the deal$")
	public void delete_the_deal() throws InterruptedException, IOException {
		dealofdaypage.verifydeletedeal();

	}

	@And("^delete the edit deal$")
	public void delete_the_edit_deal() throws InterruptedException, IOException {
		dealofdaypage.verifyeditdeletedeal();

	}

	@And("^check download sample file in productid tab$")
	public void check_download_sample_file_in_productid_tab() throws InterruptedException, IOException {
		dealofdaypage.verifyfiledownloadod();

	}

	@And("^upload product by excel$")
	public void upload_product_by_excel() throws InterruptedException, IOException {
		dealofdaypage.verifyuploadproductexcel();

	}

	@And("^add product using productid option$")
	public void add_product_using_productid_option() throws InterruptedException, IOException {
		dealofdaypage.verifyuploadproductbyid();

	}

	@And("^check export option on dod$")
	public void check_export_option_on_dod() throws InterruptedException, IOException {
		dealofdaypage.verifyexportondod();

	}

	@And("^click on delete all$")
	public void click_on_delete_all() throws InterruptedException, IOException {
		dealofdaypage.verifydeleteall();

	}

	@And("^edit the deal$")
	public void edit_the_deal() throws InterruptedException, IOException {
		dealofdaypage.editdeal();

	}

	@Then("^verify deal should be updated successfully$")
	public void verify_deal_should_be_updated_successfully() throws InterruptedException, IOException {
		dealofdaypage.verifyeditdeal();

	}

	@Then("^perform download sample file and create dod with product upload$")
	public void vperform_download_sample_file_and_create_dod_with_product_upload() throws Exception {
