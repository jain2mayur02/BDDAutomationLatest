...
public class DealOfDayPage {
	...
	public DealOfDayPage(WebDriver driver) throws InterruptedException {
		DealOfDayPage.driver = driver;
		PageFactory.initElements(driver, this);

	}

	@FindBy(xpath = "//span[contains(@class, 'text') and text() = 'Products management']")
	...
	public void createdod() throws InterruptedException, IOException {
		BaseClass.createalert("Create DOD For Market Basis ",DealOfDayPage.driver);
		...
		dealdatesave.click();
		BaseClass.createalert("DOD Created Successfully",DealOfDayPage.driver);
	}

	public void verifycreate() throws InterruptedException, IOException {
		BaseClass.createalert("Validate DOD Reflected With Correct Entries",DealOfDayPage.driver);
		...
		dealdatesearchto.sendKeys(doddates + " 23:59:59");
		//showactual.click();
		...
		Assert.assertEquals(getdodvalidto.getText(), doddates + " 23:59:59");
		...
		BaseClass.createalert("DOD  Validation Successful ",DealOfDayPage.driver);

	}

	public void syncdeal() throws InterruptedException, IOException {
		BaseClass.createalert("Sync the Deal  ",DealOfDayPage.driver);
		syncdeal.click();
	}
	...
	public void verifydeletedeal() throws InterruptedException, IOException {

		driver.navigate().refresh();
		BaseClass.createalert("Verify Delete Deal  ",DealOfDayPage.driver);
		BaseClass.selectdropdown(DealOfDayPage.driver, dealofthedaymrkdropdwnouter, "LB");
		/*
		...
		BaseClass.createalert("Deal Deleted Veirfy Successfully",DealOfDayPage.driver);

	}

	public void verifyeditdeletedeal() throws InterruptedException, IOException {

		driver.navigate().refresh();
		BaseClass.createalert("Verify Edit Delete Deal",DealOfDayPage.driver);
	...
	public void verifyfiledownloadod() throws InterruptedException, IOException {

		BaseClass.createalert("Verify File Download",DealOfDayPage.driver);
		dealofthedaybtn.click();
	...
	public void verifyuploadproductexcel() throws InterruptedException, IOException {
		
		BaseClass.createalert("Verify Upload Product Excel",DealOfDayPage.driver);
		dealofthedaybtn.click();
		BaseClass.waitForVisibility(dealofthedaymrkdropdwn, DealOfDayPage.driver);
		dealofthedaymrkdropdwn.click();
		// dealofthedaymrkUZ.click();
	...
	public void verifyuploadproductbyid() throws InterruptedException, IOException {
		BaseClass.createalert("Verify Upload Product by Product ID",DealOfDayPage.driver);
		dealofthedaybtn.click();
		BaseClass.waitForVisibility(dealofthedaymrkdropdwn, DealOfDayPage.driver);
		dealofthedaymrkdropdwn.click();
		// dealofthedaymrkUZ.click();
		...
		addproductiddod.sendKeys("949110");
	...
	public void verifyexportondod() throws InterruptedException, IOException {
		BaseClass.createalert("Verify Export DOD",DealOfDayPage.driver);
		dealofthedaybtn.click();
		BaseClass.waitForVisibility(dealofthedaymrkdropdwn, DealOfDayPage.driver);
		dealofthedaymrkdropdwn.click();
		// dealofthedaymrkUZ.click();
	...
	public void verifydeleteall() throws InterruptedException, IOException

	{
		BaseClass.createalert("Verify Delete All",DealOfDayPage.driver);
	...
	public void editdeal() throws InterruptedException, IOException {
		BaseClass.createalert("Edit The Deal",DealOfDayPage.driver);
		Thread.sleep(3000);
	...
	public void verifyeditdeal() throws InterruptedException, IOException {

		driver.navigate().refresh();
		BaseClass.createalert("Verify Edit Deal",DealOfDayPage.driver);
		BaseClass.selectdropdown(DealOfDayPage.driver, dealofthedaymrkdropdwnouter, "KZ");
	...
	public void verifydownloadandproductupload() throws Exception {
